...
#define STRING_CONFIG_H_AUTHOR "(kylix.rd: BTT002 MK3S/TMC2209s)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Blue Bear"
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    PC12     // LED driving pin
